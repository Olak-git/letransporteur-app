    ...
    const getNotifications = async (a:string|undefined) => {
        ...
        let api = !a ?
                        '/notifications' :
                            a=='prev' ?
                                (prev_page_url ? 
                                    prev_page_url.replace(API_URI, '') : '/notifications'
                                ) :
                                a=='next' ?
                                    (next_page_url ? 
                                        next_page_url.replace(API_URI, '') : '/notifications'
                                    ) : 
                                    a=='current_page' ?
                                        `/notifications?page=${current_page}` : '/notifications'
                ...
                <CardTitle className='text-base'>
                    ...
                    <div className="flex flex-wrap justify-between items-center gap-y-5 gap-x-10">
                        <div className="flex gap-x-10">
                            ...
                            <label htmlFor="items_unreaded" className="space-x-2 flex items-center">
                                <Checkbox
                                    id={`items_unreaded`}
                                    onCheckedChange={(checked) => {
                                        if(checked) {
                    ...
                    <TableBody className=''>
                        {loading ? (
                            <TableRow className='border-0 text-xs'>
                                <TableCell className="">
                                    <Helper content="Chargement en cours..." loader />
